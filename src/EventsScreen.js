  ...
  const Event = ({ item }) => (
    <View style={{ height: 150,
      ...
      <TouchableOpacity  style ={{flex: 1 }} onPress={() => { setSelectedEvent(item); setModalVisible(true); }}>
        ...
        <Text style={{marginHorizontal: '7%', fontSize: 22, color: 'black', marginTop: '5%', justifyContent: 'center', fontWeight: 'bold', textShadowColor: 'white', textShadowOffset: {width: -1, height: 1}, textShadowRadius: 10, shadowOpacity: 1,}}>{item[0]}</Text>
