...
import {OverlayProvider, Chat, Search} from 'stream-chat-react-native'; // Or stream-chat-expo
  ...
  if (!clientIsReady) {
    return (
      <Text
        style={
          darkMode
            ? {color: 'white', textAlign: 'center', marginTop: 150}
            : {color: 'black', textAlign: 'center', marginTop: 150}
        }>
        Loading chat ...
      </Text>
    );
