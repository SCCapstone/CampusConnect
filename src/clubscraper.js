...
(async () => {
  ...
  const SBOBRT = await page.$eval('#react-app > div > div > div > div.MuiGrid-root.MuiGrid-container.MuiGrid-spacing-xs-3 > div.MuiGrid-root.MuiGrid-item.MuiGrid-grid-xs-12.MuiGrid-grid-sm-12.MuiGrid-grid-md-9.MuiGrid-grid-lg-9 > div > div:nth-child(2) > div:nth-child(1)', el => el.textContent);
  const regex = /of (\d+)/;
  ...
  while (true) {
    try {
      await page.waitForSelector('#react-app > div > div > div > div.MuiGrid-root.MuiGrid-container.MuiGrid-spacing-xs-3 > div.MuiGrid-root.MuiGrid-item.MuiGrid-grid-xs-12.MuiGrid-grid-sm-12.MuiGrid-grid-md-9.MuiGrid-grid-lg-9 > div > div:nth-child(2) > div.outlinedButton > button', { timeout: 10000 });
      await page.click('#react-app > div > div > div > div.MuiGrid-root.MuiGrid-container.MuiGrid-spacing-xs-3 > div.MuiGrid-root.MuiGrid-item.MuiGrid-grid-xs-12.MuiGrid-grid-sm-12.MuiGrid-grid-md-9.MuiGrid-grid-lg-9 > div > div:nth-child(2) > div.outlinedButton > button');
    } catch (error) {
      break;
    }
  }
  ...
  for (let i = 1; i <= numResultsInteger; i++) {
    ...
    const defaultClub = { title: 'Club Title', description: 'Club Description', 
    imgSrc: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/South_Carolina_Gamecocks_logo.svg/200px-South_Carolina_Gamecocks_logo.svg.png'
    ...
    defaultClub.title = await page.$eval(titleSelector, (el, defaultClub) => defaultClub.title = el.innerText, defaultClub);
    ...
    defaultClub.description = await page.$eval(descriptionSelector, (el, defaultClub) => defaultClub.title = el.innerText, defaultClub);
