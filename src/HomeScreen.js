...
import ChatComponent from './ChatContext'
...
export function HomeScreen({navigation}) {
  ...
  return (
          <Drawer.Navigator drawerContent={props => <DrawerContent {...props} />}
            ...
            <Drawer.Screen name="Chats" component={Chat} options={{headerTitle:'Campus Connect: DMs'}}/>
            <Drawer.Screen name="Create Group" component={CreateGroup} options={{headerTitle:'Create Group Chat', drawerItemStyle: { height: 0 }}}/>
            <Drawer.Screen name="Message" component={Message} options={{headerTitle:'Currently Chatting', drawerItemStyle: { height: 0 }}}/>
          </Drawer.Navigator>
  );
}