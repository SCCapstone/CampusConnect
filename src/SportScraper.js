...
const LoadSportEvents = (HTMLString, eventCount) => {
  ...
  imageList.each((i, el) => {
    ...
    if (img === undefined) imageArray.push(DEFAULTSECLOGO); // Use SEC logo if there's no opponent logo
    else if (img != DEFAULTGAMECOCKLOGOURL1 && img != DEFAULTGAMECOCKLOGOURL2 && img != BEACHVOLLEYBALLLOGO)
